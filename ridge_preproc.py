...
# Replace negative target values in train with 0
train_df.loc[train_df['Transport_Cost'] < 0, 'Transport_Cost'] = 0

# Calculate mean of positive Transport_Cost values
mean_positive_cost = train_df.loc[train_df['Transport_Cost'] > 0, 'Transport_Cost'].mean()

# Replace 0 values (originally negative) with mean positive cost
...
# Replace negative predicted costs with mean of positive predicted costs
